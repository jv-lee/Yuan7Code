...
public class ZipDecryptInputStream extends InputStream {
    ...
    public static boolean readAssetsZipFile(Context context, String fileName, String password, String saveFilePath, String saveFileName) {
        try {
            InputStream is = context.getAssets().open(fileName);

            ZipDecryptInputStream zdis = new ZipDecryptInputStream(is, password);
            ZipInputStream zis = new ZipInputStream(zdis);

            ZipEntry ze;
            while ((ze = zis.getNextEntry()) != null) {
                File files = new File(saveFilePath, saveFileName);
