...
abstract class BaseHttp extends Thread {
    ...
    public BaseHttp(Context context, Handler handler) {
    ...
    public BaseHttp(Context context, String url) {
        mContext = context;
        this.url = url;
    }

    public BaseHttp(Context context, int status) {
        mContext = context;
        this.status = status;
    }
