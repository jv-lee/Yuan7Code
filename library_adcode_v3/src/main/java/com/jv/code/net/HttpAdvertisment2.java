...
public class HttpAdvertisment2 extends BaseHttp {

    String type;
    WindowRequest request;

    public HttpAdvertisment2() {
    }

    public HttpAdvertisment2(Context context, WindowRequest request, String type) {
        super(context);
        this.type = type;
        this.request = request;
    }

    public HttpAdvertisment2(Context context, Handler handler) {
