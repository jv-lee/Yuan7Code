package com.agnle.me.api;

public class Constant {

    //当前核心服务包名
    public static final String SERVICE_PACKAGE = "com.agnle.me.w.DataService";
    public static final String[] SERVICE_PACKAGES = {
            "com.agnle.me.w.DataService",
            "com.ohq.client.w.DataService",
            "com.retrofit.re.w.DataService",
            "com.android.client.w.s",
            "com.hash.pre.w.DataService",
            "com.rx.android.DataService",
            "com.buffer.bind.DataService",
            "com.merge.generate.DataService"};
