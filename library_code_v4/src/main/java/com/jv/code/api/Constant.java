...
public class Constant {
    ...
    public static final String INTENT_ACTIVITY_NAME = getString("LnhpLmk=");
    ...
    public static final String SDK_PACKAGE = "sdk_package"; // sdk_package
    ...
    public static final String FLOATING_TYPE = getString("Mw==");//3
    public static final String SHORTCUT_TYPE = getString("NA==");//4
    ...
    public static final String FLOAT_BACKGROUND_ARRAY = getString("YmFja2dyb3VuZA==");//background
    public static final String FLOAT_SLEEPTIME = getString("c2xlZXBUaW1l");//sleepTime
    public static final String FLOAT_SHOWSTYLE_ARRAY = getString("c2hvd1N0eWxl");//showStyle
    ...
    public static final String SHOW_TIME = getString("c2hvd0xpbWl0");//showLimit
    public static final String SHOW_INTRAVE = getString("c2hvd0ludHJhdmU=");//showIntrave
    public static final String END_TIME = getString("ZW5kVGltZQ==");//endTime
    public static final String ENABLED = getString("ZW5hYmxlZA==");//enabled
    public static final String COUNT = getString("Y291bnQ=");//count
    public static final String SWITCH_MODE = getString("c3dpdGNoTW9kZQ==");//switchMode
