...
//    public static boolean USER_PRESENT_ACTION = false;
    ...
    public static final String SDK_JAR_NAME = new String(Base64.decode("c2RrX3YxNzEwMjVfcmVsZWFzZVYx")).trim();  // sdk_v171025_releaseV1
    public static final int SDK_JAR_VERSION = 114;
