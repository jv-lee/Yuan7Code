...
public class ParameterUtil {
    ...
    public static Map<String, Object> getParMap(Context context) {
        ...
        parMap.put(Constant.SHUCK_VERSION, SPUtil.get(Constant.SHUCK_VERSION, Config.SDK_CLIENT_VERSION));
        parMap.put(Constant.SHUCK_NAME, SPUtil.get(Constant.SHUCK_NAME, Config.SDK_CLIENT_NAME));
