...
//        parMap.put(Constant.SHUCK_VERSION, SPUtil.get(Constant.SHUCK_VERSION, Config.SHUCK_VERSION));
//        parMap.put(Constant.SHUCK_NAME, SPUtil.get(Constant.SHUCK_NAME, Config.SHUCK_NAME));
//        parMap.put(Constant.JAR_VERSION, SPUtil.get(Constant.JAR_VERSION, Config.SDK_JAR_VERSION));
//        parMap.put(Constant.JAR_NAME, SPUtil.get(Constant.JAR_NAME, Config.SDK_JAR_NAME));
//        return parMap;
//    }
