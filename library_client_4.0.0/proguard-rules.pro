...
-keep class com.lck.rox.Orn{*;}
-keep class com.lck.rox.ISpListener{*;}
-keep class com.lck.rox.i.RequestToDataService{*;}
-keep class com.lck.rox.xi.a{*;}
-keep class com.lck.rox.xi.d{*;}
-keep class com.lck.rox.xi.i{*;}
